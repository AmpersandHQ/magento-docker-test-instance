...
RUN sed -i 's/nobody/www-data/' /root/.phpenv/versions/8.2.2/etc/php-fpm.d/www.conf && sed -i 's/nobody/www-data/' /root/.phpenv/versions/8.1.6/etc/php-fpm.d/www.conf && sed -i 's/nobody/www-data/' /root/.phpenv/versions/7.4.29/etc/php-fpm.d/www.conf
