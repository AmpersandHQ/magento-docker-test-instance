FROM ampco/magento-docker-test-instance-php:20250511
SHELL ["/bin/bash", "-c"]
...
RUN sed -i 's/nobody/ampersand/' /home/ampersand/.phpenv/versions/8.3.21/etc/php-fpm.d/www.conf && sed -i 's/nobody/ampersand/' /home/ampersand/.phpenv/versions/8.2.28/etc/php-fpm.d/www.conf && sed -i 's/nobody/ampersand/' /home/ampersand/.phpenv/versions/8.1.32/etc/php-fpm.d/www.conf && sed -i 's/nobody/ampersand/' /home/ampersand/.phpenv/versions/7.4.29/etc/php-fpm.d/www.conf
